...
export default {
  ...
  theme: {
    extend: {
      ...
      gap: {
        collection: "var(--collection-gap)",
        "collection-item": "var(--collection-item-gap)",
        "collection-text": "var(--collection-text-gap)",
      },
      fontFamily: {
      ...
      backgroundImage: {
        ...
        "mobile-menu-gradient":
          "linear-gradient(0deg, rgba(254, 252, 247, 0.5) 0%, rgba(254, 252, 247, 1) 60%)",
      },
      screens: {
        desktop: "1440px",
      },
